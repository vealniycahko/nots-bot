...
@dp.callback_query_handler(
    lambda callback_query: callback_query.data.startswith("change")
)
...
@dp.callback_query_handler(
    ...
    state=ChangeNoteStates.WAITING_TZ,
)
...
@dp.callback_query_handler(
    lambda callback_query: callback_query.data == "skip_update_call", state="*"
)
...
@dp.callback_query_handler(
    lambda callback_query: callback_query.data == "clean_update_call", state="*"
)
