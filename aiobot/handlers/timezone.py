...
@dp.callback_query_handler(lambda callback_query: callback_query.data == 'time_zone_call')
...
@dp.callback_query_handler(lambda callback_query: callback_query.data == 'modify_timezone_call')
async def timezone_call(callback_query: CallbackQuery):
    await callback_query.answer()
